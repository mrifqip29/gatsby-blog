...
import Ilkom from "../images/logo-ilkom.png"
    ...
    <div>
      ...
      >
        <path
          fill="#004547"
          fill-opacity="1"
          d="M0,192L80,181.3C160,171,320,149,480,165.3C640,181,800,235,960,256C1120,277,1280,267,1360,261.3L1440,256L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
        ></path>
      </svg>

      <div
        className={`row d-flex justify-content-md-center justify-content-sm-start px-4 m-0 ${footerStyles.containerFooter}`}
      >
        ...
        <div className="col-md-4 col-sm-12 pr-0">
          ...
          <h5 className={footerStyles.content}>
            {data.contentfulFooter.alamatSekolah}{" "}
          </h5>
        </div>
      </div>
      <div
        className={`row d-flex justify-content-md-center justify-content-sm-start px-4 m-0 ${footerStyles.containerFooter}`}
      >
        <h5 className={footerStyles.content} style={{ marginBottom: "-40px" }}>
          Created by:
        </h5>
      </div>
      <div
      ...
      >
        <img
          src={Ilkom}
          style={{ position: "center", width: "20%", height: "20%" }}
        />
      </div>
    </div>
  )
